...
router.get("/",protect, async (req, res) => {
    try {
        ...
        const { page, limit, tourLimit, type, ...filter } = req.query
        const result = await bannerController.getAllBanners({ page, limit, type }, filter);
const isDisabled=false;
        // const popularTour = await packageController.getPackages({userId,isDisabled}, 
        const popularTour = await packageController.getPackages({userId,isDisabled}, {
